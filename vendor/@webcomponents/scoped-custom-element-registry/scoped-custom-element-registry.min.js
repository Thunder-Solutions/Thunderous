console.log(globalThis.ShadowRoot, typeof ShadowRoot);
(function(){
/*
...
var e=d.apply(a||this,arguments);void 0!==e&&G.set(e,this);K.pop();return e}};O(ShadowRoot,"createElement",document);O(ShadowRoot,"importNode",document);O(Element,"insertAdjacentHTML");O(Node,"appendChild");O(Element,"append");var P=function(b){var c=Object.getOwnPropertyDescriptor(b.prototype,"innerHTML");Object.defineProperty(b.prototype,"innerHTML",Object.assign({},c,{set:function(a){K.push(this);c.set.call(this,a);K.pop()}}))};P(Element);P(ShadowRoot);Object.defineProperty(window,"customElements",{value:new CustomElementRegistry,configurable:!0,
